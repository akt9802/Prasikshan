...
export default function DisplayTenQuestion() {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        setLoading(true);
        const response = await fetch("/api/questions/tenquestions");
        ...
        <PageShell>
          <div className="w-full max-w-2xl">
            ...
            <div className="flex gap-3">
              <button onClick={() => window.location.href = '/tenquestion'}
        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="rounded-2xl px-6 py-4 mb-4 flex items-center justify-between"
            ...
            <div>
              ...
              <p className="text-white font-black text-lg">10 Questions</p>
            </div>
                ...
                return (
                  <button key={idx} onClick={() => handleAnswerSelect(option)}
                    ...
                    <span className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-black shrink-0 transition-all duration-200"
                      style={{ background: selected ? B.navy : 'rgba(18,77,150,0.10)', color: selected ? '#fff' : B.navy }}>
