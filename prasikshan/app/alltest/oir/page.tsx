  ...
  const instructions = [
    {
      ...
      desc: "This test consists of 40 questions designed to assess your verbal and non-verbal reasoning.",
    ...
    },
    {
      id: 2,
      title: "Time Limit",
      desc: "You have 40 minutes for the entire test. Manage your time to ensure you can visit every question.",
    ...
    },
    {
      ...
      desc: "There is no negative marking. Attempt all questions even if you are unsure of the answer.",
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="7" /><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88" /></svg>
    },
    {
      id: 4,
      title: "Focus & Conduct",
      desc: "Maintain concentration. Do not close or refresh the window while the test is in progress.",
    ...
    },
    {
      ...
      desc: "You can navigate between questions, skip them, and mark them for review as needed.",
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
    },
    {
      id: 6,
      title: "Review Finality",
      desc: "Once you submit the test, you cannot go back. Ensure all your chosen answers are correct.",
        ...
        <div className="relative overflow-hidden pt-16 pb-20 px-4" style={{ background: `linear-gradient(135deg, ${B.navyDeep}, ${B.navyDark})` }}>
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full mb-6" style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)' }}>
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-blue-100">Testing Environment</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-black text-white mb-4 leading-tight">
              Officer Intelligence Rating <span className="text-blue-300">(OIR)</span>
            </h1>
            <p className="text-lg font-medium max-w-2xl mx-auto" style={{ color: 'rgba(190,227,248,0.7)' }}>
              A standard test of intelligence consisting of verbal and non-verbal reasoning questions. Follow the instructions to maximize your rating.
            </p>
          </div>
        </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                <div className="text-left md:max-w-md">
                  ...
                  <p className="text-sm font-medium" style={{ color: B.textMuted }}>
                    Ensure you have a stable internet connection and a quiet environment. The timer will start immediately.
                  </p>
                </div>
                <Link
