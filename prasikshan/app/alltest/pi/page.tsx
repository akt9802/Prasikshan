        ...
        <div className="flex-1 -mt-10 px-4 pb-16 relative z-20">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              <div className="rounded-2xl p-6 flex items-center gap-5" style={{ background: 'rgba(6,182,212,0.05)', border: '1.5px solid rgba(6,182,212,0.15)' }}>
                <div className="w-14 h-14 rounded-full flex items-center justify-center shrink-0" style={{ background: 'rgba(6,182,212,0.1)', color: '#0891B2' }}>
                ...
                <div>
                  <p className="text-xs font-black uppercase tracking-widest text-[#0891B2] mb-1">Interaction Mode</p>
                  <p className="text-2xl font-black" style={{ color: B.textDark }}>Interactive Q&A</p>
                </div>
              </div>
              <div className="rounded-2xl p-6 flex items-center gap-5" style={{ background: 'rgba(37,99,235,0.05)', border: '1.5px solid rgba(37,99,235,0.15)' }}>
                ...
                <div>
                  <p className="text-xs font-black uppercase tracking-widest text-[#2563EB] mb-1">Typical Duration</p>
                  <p className="text-2xl font-black" style={{ color: B.textDark }}>30 - 60 Minutes</p>
                </div>
              </div>
            </div>
