...
const data = [
  ...
  { attempt: "Attempt 4", score: 16, maxScore: 25, date: "2025-08-08" },
  ...
  { attempt: "Attempt 3", score: 1, maxScore: 25, date: "2025-08-05" },
  { attempt: "Attempt 3", score: 8, maxScore: 25, date: "2025-08-05" },
  { attempt: "Attempt 3", score: 12, maxScore: 25, date: "2025-08-05" },
  { attempt: "Attempt 3", score: 18, maxScore: 25, date: "2025-08-05" },
  { attempt: "Attempt 3", score: 1, maxScore: 25, date: "2025-08-05" },
];

function OirScore({ oirData = data }) {
  return (
    <div
      style={{
        width: "100%",
